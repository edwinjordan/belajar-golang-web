...
func TestMultipleQueryParameter(t *testing.T) {
	request := httptest.NewRequest(http.MethodGet, "http://localhost:8080/hello?first_name=Eko&last_name=Laksono", nil)
	recorder := httptest.NewRecorder()
...
func TestMultipleyParameterValues(t *testing.T) {
